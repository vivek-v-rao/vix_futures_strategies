...
#the second tenor counts used to be one too high: pandas_market_calendars once counted June 19 2023
#(Juneteenth) as a trading day, and the expected values were written to match.  the calendar now has it
#as a holiday, which is right - the CBOE futures files have no trading that day - so the counts to the
#July 19 expiry are 32 and 21 rather than 33 and 22.

trade_days_data=[ ('2023-06-01',13,32),
                 ('2023-06-16', 2,21),
                ('2023-03-31',12,32)]
